// Using a generic reliable placeholder from Imgur
const PLACEHOLDER_IMG = "https://i.imgur.com/Cjq8e8g.png"; // A clean white/grey placeholder
...
export const productData = {
    "PABX": {
        ...
        products: [
            ...
            { id: "VP-500", name: "VP-500", description: "Robust voice platform.", image: PLACEHOLDER_IMG, images: [PLACEHOLDER_IMG, PLACEHOLDER_IMG, PLACEHOLDER_IMG, PLACEHOLDER_IMG, PLACEHOLDER_IMG] },
            { id: "VP-3000", name: "VP-3000", description: "High-capacity voice server.", image: PLACEHOLDER_IMG, images: [PLACEHOLDER_IMG, PLACEHOLDER_IMG, PLACEHOLDER_IMG, PLACEHOLDER_IMG, PLACEHOLDER_IMG] }
        ]
    },
    "Telephone": {
        title: "Telephone",
        ...
        products: [
            ...
            { id: "IPV-78H", name: "IPV-78H", description: "HD Voice IP Phone.", image: PLACEHOLDER_IMG },
            { id: "IPV-72H", name: "IPV-72H", description: "Entry-level IP Phone.", image: PLACEHOLDER_IMG },
            { id: "IP-76", name: "IP-76", description: "Basic business phone.", image: PLACEHOLDER_IMG }
        ]
    },
    "Nurse Call": {
        title: "Nurse Call",
        ...
        products: [
            ...
            { id: "AK-77", name: "AK-77", description: "Corridor light indicator.", image: PLACEHOLDER_IMG }
        ]
    },
    "Voice Logger": {
        title: "Voice Logger",
