        ...
        <section className="py-12 bg-white">
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                ...
                <div className="mb-12 max-w-4xl">
                    ...
                    <p className="text-4xl md:text-5xl font-bold tracking-tight text-[#1d1d1f] leading-tight">
                        Reliable. Scalable. <br />
                        <span className="text-[#86868b]">Future-Ready.</span>
                    </p>
                </div>

                {/* Pure Typography Layout - Compact */}
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-y-10 lg:gap-x-12">
                    ...
                    <div className="lg:col-span-6">
                        ...
                        <p className="text-base font-medium text-[#86868b] leading-normal max-w-lg">
